...
- Keep PROGRESS.md up-to-date after each session with:
...
**Key principle:** Introduce terms *in context* when they solve a real problem the mentee has encountered, not as vocabulary lessons.
...
- When updating PROGRESS.md or documentation
