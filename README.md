...
> Старт: 2026-06-06 | Уровень: Junior | Текущий блок: 2.5 — ООП и модель данных, темы 1-3 завершены (тема 3 "Наследование" — 2026-07-27); остаётся долг по блоку 2.7 (темы 2-5)
...
| 2.5 | ООП и модель данных | 🔄 В процессе, темы 1-3 завершены (тема 3 — 2026-07-27) |
...
|---------|--------|--------|
| Junior  | 2.1, 2.2, 2.3, 2.4 завершены; 2.5 (ООП) в процессе (темы 1-3); долг по 2.7 (темы 2-5) | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-07-27 (сеанс 21: блок 2.5 тема 3 "Наследование, super(), MRO" завершена 8/8; остаётся тема 4 (dunder-методы) и последний долг — блок 2.7, темы 2-5)
**Python:** 3.12+
