...
> Старт: 2026-06-06 | Уровень: Junior | Текущий блок: 2.5 — ООП и модель данных, темы 1-6 завершены (тема 6 "dunder-методы" — 2026-08-11); остаётся долг по блоку 2.7 (темы 2-5)
...
| 2.5 | ООП и модель данных | 🔄 В процессе, темы 1-6 завершены (тема 6 — 2026-08-11) |
...
├── 2.5_oop/                    # В процессе, темы 1-6 завершены (тема 6 — 2026-08-11)
...
|---------|--------|--------|
| Junior  | 2.1, 2.2, 2.3, 2.4 завершены; 2.5 (ООП) в процессе (темы 1-6); долг по 2.7 (темы 2-5) | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-08-11 (сеанс 25: блок 2.5 тема 6 "dunder-методы" завершена 8/8; остаются темы 7-9 (abc.ABC, Enum, 4 столпа ООП) и последний долг — блок 2.7, темы 2-5)
**Python:** 3.12+
