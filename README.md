...
> Старт: 2026-06-06 | Уровень: Junior | Текущий блок: 2.5 — ООП и модель данных, темы 1-5 завершены (тема 5 "dataclasses" — 2026-08-10); остаётся долг по блоку 2.7 (темы 2-5)
...
| 2.5 | ООП и модель данных | 🔄 В процессе, темы 1-5 завершены (тема 5 — 2026-08-10) |
...
├── 2.5_oop/                    # В процессе, темы 1-5 завершены (тема 5 — 2026-08-10)
...
│   └── 11_dunder_methods_demo.py + 12_dunder_methods_task.py  # тема 6, следующая
...
|---------|--------|--------|
| Junior  | 2.1, 2.2, 2.3, 2.4 завершены; 2.5 (ООП) в процессе (темы 1-5); долг по 2.7 (темы 2-5) | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-08-10 (сеанс 24: блок 2.5 тема 5 "dataclasses" завершена 8/8; остаётся тема 6 (dunder-методы) и последний долг — блок 2.7, темы 2-5)
**Python:** 3.12+
