...
> Старт: 2026-06-06 | Уровень: Junior | Текущий блок: 2.7 — Ошибки и исключения, тема 1 завершена 8/8 (2026-07-09), блок на паузе — дальше свободная практика вне роудмапа
...
| 2.4 | Модули, файлы и дата/время | Запланировано |
| 2.5 | ООП и модель данных | Запланировано (после 2.7) |
| 2.6 | Типизация и качество кода | Запланировано (после 2.7) |
| 2.7 | Ошибки и исключения | Тема 1 завершена 8/8, блок на паузе |
...
│
├── 2.4_modules_files_datetime/ # Запланировано (модули, pathlib, csv/json, datetime)
├── 2.5_oop/                    # Запланировано (после 2.7)
├── 2.6_typing/                 # Запланировано (после 2.7)
├── 2.7_exceptions/             # Тема 1 завершена (8/8), на паузе
...
|---------|--------|--------|
| Junior  | 2.1 завершён, 2.2 почти, 2.3 ждёт оценку, 2.7 тема 1 завершена (на паузе) | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-07-13 (реструктуризация роудмапа: добавлен Блок 2.4 «Модули, файлы и дата/время», блоки 2.4–2.9 сдвинуты на +1; последняя учебная сессия — 2026-07-09, блок 2.7 (бывш. 2.6) тема 1 завершена 8/8, дальше свободная практика)
**Python:** 3.12+
