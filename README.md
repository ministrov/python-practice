...
**Последнее обновление:** 2026-08-19 (долг закрыт: финальная оценка блока 2.4 пройдена 100% — модули/файлы/дата-время; блок 2.7 полностью завершён; остаётся долг — финальная оценка блока 2.6; далее блок 2.8, базы данных и SQL)
**Python:** 3.12+
