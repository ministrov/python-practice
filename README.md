...
> Старт: 2026-06-06 | Уровень: Junior | Текущий блок: 2.5 — ООП и модель данных, тема 1 в работе (начат внепланово 2026-07-20)
...
| 2.2 | Структуры данных | Темы завершены, финальная оценка — долг (перенесена на 2026-07-24) |
| 2.3 | Функции | Темы завершены, финальная оценка — долг (перенесена на 2026-07-24) |
| 2.4 | Модули, файлы и дата/время | Темы 1, 3 завершены; тема 2 (файлы продвинуто) — долг (2026-07-24) |
| 2.5 | ООП и модель данных | 🔄 В процессе, тема 1 (начато внепланово 2026-07-20) |
...
├── 2.5_oop/                    # В процессе, тема 1 (начато 2026-07-20)
...
└── ASSESSMENT_Block_2_2.md      # долг (2026-07-24) — файл ещё не создан
```
...
|---------|--------|--------|
| Junior  | 2.1 завершён; 2.5 (ООП) в процессе; долги по 2.2/2.3/2.4/2.7 отложены на 2026-07-24 | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-07-20 (сеанс 15: старт Блока 2.5 «ООП» внепланово; долги по блокам 2.2/2.3/2.4/2.7 перенесены на 2026-07-24)
**Python:** 3.12+
