...
> Старт: 2026-06-06 | Уровень: Junior | Блок 2.7 — ошибки и исключения — темы 1-4 завершены, тема 5 (logging) следующая (2026-08-19)
...
| 2.7 | Ошибки и исключения | Темы 1-4 завершены (тема 2 полной практикой 7/7); тема 5 (logging) — следующая |
...
├── 2.7_exceptions/             # Темы 1-4 завершены, тема 5 (logging) следующая
│   ├── 01_exceptions_basics_demo.py + 02_exceptions_basics_task.py (8/8)
│   ├── 03_raise_from_demo.py + 04_raise_from_task.py (7/7, 2026-08-19)
│   ├── 05_context_managers_demo.py          # ознакомительно, 2026-08-19
│   └── 06_stdlib_demo.py                    # ознакомительно, 2026-08-19
...
|---------|--------|--------|
| Junior  | 2.1-2.6 завершены (2.5 ООП: 9 тем + финальная оценка 100%; 2.6 типизация: все 5 тем); 2.7 темы 1-4 завершены, тема 5 (logging) следующая | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-08-19 (блок 2.6 полностью завершён 2026-08-18; блок 2.7 темы 2-4 завершены — тема 2 `raise from`/`ExceptionGroup` полной практикой 7/7, темы 3-4 контекстные менеджеры/stdlib ознакомительно; далее тема 5, logging)
**Python:** 3.12+
