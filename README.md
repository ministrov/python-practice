...
> Старт: 2026-06-06 | Уровень: Junior | Текущий блок: 2.6 — Ошибки и исключения (начат внепланово 2026-07-09, до 2.4/2.5 — по решению пользователя, ветка `feature/error-handling`)
...
| 2.6 | Ошибки и исключения | В процессе — начат внепланово 2026-07-09 |
...
├── 2.6_exceptions/             # В процессе (внепланово, до 2.4/2.5)
│   ├── 01_exceptions_basics_demo.py + 02_exceptions_basics_task.py
│   └── (далее: raise from, контекстные менеджеры, stdlib, logging)
...
|---------|--------|--------|
| Junior  | 2.1 завершён, 2.2 почти, 2.3 ждёт оценку, 2.6 в процессе | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-07-09 (сеанс 12: старт блока 2.6, обработка ошибок — основы try/except)
**Python:** 3.12+
