...
> Старт: 2026-06-06 | Уровень: Junior | Текущий блок: 2.4 — Модули, файлы и дата/время, тема 1 (модули) завершена 8/8 (2026-07-13)
...
| 2.4 | Модули, файлы и дата/время | Тема 1 (модули) завершена 8/8 |
...
│
├── 2.4_modules_files_datetime/ # Тема 1 (модули) завершена
...
│   └── (далее: файлы продвинуто, дата и время — не запланировано)
...
|---------|--------|--------|
| Junior  | 2.1 завершён, 2.2 почти, 2.3 ждёт оценку, 2.4 тема 1 завершена, 2.7 тема 1 завершена (на паузе) | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-07-13 (сеанс 13: блок 2.4 тема 1 «Модули» завершена 8/8; ранее в этот же день — реструктуризация роудмапа, добавлен Блок 2.4, блоки 2.4–2.9 сдвинуты на +1)
**Python:** 3.12+
