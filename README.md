...
**Последнее обновление:** 2026-08-20 (долг закрыт: финальная оценка блока 2.6 пройдена 100% — типизация, часть 2 «Каталог товаров»; долгов по финальным оценкам блоков 2.1–2.7 больше нет; далее блок 2.8, базы данных и SQL)
**Python:** 3.12+
