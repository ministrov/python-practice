...
> Старт: 2026-06-06 | Уровень: Junior | Текущий блок: 2.5 — ООП и модель данных, все 9 тем завершены (2026-08-13); ждёт финальная оценка блока (`assessments/ASSESSMENT_Block_2_5.md`); остаётся долг по блоку 2.7 (темы 2-5)
...
| 2.5 | ООП и модель данных | ✅ Все 9 тем завершены (2026-08-13); ждёт финальная оценка блока |
...
└── ASSESSMENT_Block_2_5.md      # НЕ пройдена (создана 2026-08-13)
```
...
|---------|--------|--------|
| Junior  | 2.1, 2.2, 2.3, 2.4, 2.5 (ООП, все 9 тем) завершены; 2.5 ждёт финальную оценку; долг по 2.7 (темы 2-5) | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-08-13 (сеанс 27: блок 2.5 полностью завершён — темы 7 (абстракция), 8 (Enum), 9 (4 столпа ООП) добраны и закрыты; создана финальная оценка `ASSESSMENT_Block_2_5.md` (ещё не пройдена); остаётся последний долг — блок 2.7, темы 2-5)
**Python:** 3.12+
