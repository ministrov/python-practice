...
|---------|--------|--------|
| Junior  | 2.1, 2.2, 2.3 завершены; 2.5 (ООП) в процессе; долги по 2.4/2.7 в отработке (2026-07-24) | В работе |
| Middle  | — | Запланировано |
| Senior  | — | Запланировано |

---

**Последнее обновление:** 2026-07-24 (сеанс 19: финальная оценка блока 2.3 пройдена — 100%; долги по блокам 2.4/2.7 остаются в отработке)
**Python:** 3.12+
