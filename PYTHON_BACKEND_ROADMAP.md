...
### Блок 2.5. ООП и модель данных (3 недели) 🔄 В ПРОЦЕССЕ (темы 1-2 завершены 2026-07-21; долги по 2.2/2.3/2.4 закрыты 2026-07-24, остаётся долг по 2.7)
