...
> **Прогресс:** Junior Level, Блоки 2.1–2.7 полностью завершены, включая финальные оценки 2.2–2.6 (100% каждая; 2.6 темы 3-5 и 2.7 темы 3-5 ознакомительно). Долгов по финальным оценкам не осталось. Блок 2.8 (БД и SQL) — следующий фронт, ещё не начат
