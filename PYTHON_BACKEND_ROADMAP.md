...
### Блок 2.6. Типизация и качество кода (2 недели) 🔄 В ПРОЦЕССЕ (начат 2026-08-14, сеанс 30)
...
- [ ] Виртуальные окружения: `venv`, управление зависимостями (`pip`, `requirements.txt`, или `uv`/`poetry`) (ознакомительно, без практики)
