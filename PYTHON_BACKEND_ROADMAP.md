...
> **Прогресс:** Junior Level, Блок 2.3 завершён (ждёт финальную оценку); Блок 2.6 (Ошибки и исключения), тема 1 (try/except основы) завершена 8/8 — ВНЕ ОЧЕРЕДИ, до 2.4/2.5; блок на паузе, дальше идёт свободная практика вне роудмапа
...
### Блок 2.6. Ошибки, исключения, стандартная библиотека (2 недели) 🔄 В ПРОЦЕССЕ, НА ПАУЗЕ (сеанс 12: 2026-07-09, начат внепланово до 2.4/2.5)
