...
- [~] Python + БД: `psycopg`, затем ORM — SQLAlchemy 2.0 (core + ORM, declarative)
  ...
  - [ ] SQLAlchemy 2.0 ORM (declarative классы, Session) — 🔄 следующий шаг
