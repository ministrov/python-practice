...
### Блок 2.5. ООП и модель данных (3 недели) 🔄 В ПРОЦЕССЕ (темы 1-8 завершены, последняя — 2026-08-13; долги по 2.2/2.3/2.4 закрыты 2026-07-24, остаётся долг по 2.7)
...
- [x] `Enum`, `IntEnum` (`StrEnum` не покрывался отдельно — не критично для
      ...
      2026-08-13)
- [ ] Обобщение: 4 столпа ООП (инкапсуляция/абстракция/наследование/
      полиморфизм) — итоговая тема блока, называет словами то, что уже
