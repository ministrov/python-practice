...
> **Старт:** 2026-06-06
> **Последний чекпойнт:** 2026-08-20
> **Прогресс:** Junior Level, Блоки 2.1–2.7 полностью завершены, включая финальные оценки 2.2–2.6 (100% каждая; 2.6 темы 3-5 и 2.7 темы 3-5 ознакомительно). Долгов по финальным оценкам не осталось. Блок 2.8 (БД и SQL) — СТАРТОВАЛ 2026-08-20, полная практика (не ознакомительно): сначала SQL через `sqlite3`, затем PostgreSQL для psycopg/SQLAlchemy/Alembic. Тема 1 (SQL basics) — демо готово, практика (8 заданий) не решена
