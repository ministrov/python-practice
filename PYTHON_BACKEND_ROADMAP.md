...
> **Старт:** 2026-06-06
> **Последний чекпойнт:** 2026-08-17 (сеанс 31)
> **Прогресс:** Junior Level, Блоки 2.1–2.5 полностью завершены (включая финальные оценки 2.2, 2.3 и 2.5, 100% каждая); Блок 2.7 (Ошибки и исключения), тема 1 (try/except основы) завершена 8/8 — ВНЕ ОЧЕРЕДИ, на паузе, темы 2-5 остаются последним долгом; Блок 2.6 не начат — следующий фронт (2.6 или долг по 2.7) не выбран
...
### Блок 2.5. ООП и модель данных (3 недели) ✅ ЗАВЕРШЕН (все 9 тем + финальная оценка пройдена 2026-08-14, 100%); долги по 2.2/2.3/2.4 закрыты 2026-07-24, остаётся долг по 2.7
