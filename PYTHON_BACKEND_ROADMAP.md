...
> **Прогресс:** Junior Level, Блоки 2.1–2.4 полностью завершены (включая финальные оценки 2.2 и 2.3, 100% каждая); Блок 2.5 (ООП) в процессе — темы 1-4 завершены 8/8 (тема 4 композиция vs наследование — 2026-07-28), тема 5 (dataclasses) следующая; Блок 2.7 (Ошибки и исключения), тема 1 (try/except основы) завершена 8/8 — ВНЕ ОЧЕРЕДИ, на паузе, темы 2-5 остаются последним долгом; Блок 2.6 не начат
...
### Блок 2.5. ООП и модель данных (3 недели) 🔄 В ПРОЦЕССЕ (темы 1-4 завершены, последняя — 2026-07-28; долги по 2.2/2.3/2.4 закрыты 2026-07-24, остаётся долг по 2.7)
