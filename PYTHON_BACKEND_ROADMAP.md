...
- [ ] HTTP-основы: методы (GET/POST/PUT/PATCH/DELETE), статус-коды, заголовки, тело — В ПРОЦЕССЕ (начато 2026-09-02, демо готово, практика 2/10 заданий: `do_GET`, `do_POST`)
