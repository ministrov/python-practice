...
> **Прогресс:** Junior Level, Блоки 2.1–2.7 полностью завершены, включая финальные оценки 2.2–2.6 (100% каждая; 2.6 темы 3-5 и 2.7 темы 3-5 ознакомительно). Долгов по финальным оценкам не осталось. Блок 2.8 (БД и SQL) — СТАРТОВАЛ 2026-08-20, полная практика (не ознакомительно). Темы 1-3 завершены 2026-08-24: SQL basics (`sqlite3`, 8/8), INSERT/UPDATE/DELETE+транзакции (6/6), PostgreSQL/`psql` (Docker-контейнер `pg-learning`, ознакомительно). psycopg-практика (свободная), SQLAlchemy 2.0 Core (7/7) и SQLAlchemy 2.0 ORM (8/8, включая бонус) завершены — Core 2026-08-25, ORM 2026-09-01. Дальше — Alembic (миграции), последняя тема блока 2.8
...
### Блок 2.4. Модули, файлы и дата/время (1–2 недели) ✅ ЗАВЕРШЕН (все 3 темы, 2026-07-24; финальная оценка 100%, 2026-08-19)
...
### Блок 2.7. Ошибки, исключения, стандартная библиотека (2 недели) ✅ ЗАВЕРШЁН (2026-07-09 → 2026-08-19)
