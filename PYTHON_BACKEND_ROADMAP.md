...
> **Старт:** 2026-06-06
> **Последний чекпойнт:** 2026-07-09 (сеанс 12)
> **Прогресс:** Junior Level, Блок 2.3 завершён (ждёт финальную оценку); Блок 2.6 (Ошибки и исключения) начат ВНЕПЛАНОВО, до 2.4/2.5 — по решению пользователя (ветка `feature/error-handling`)
...
### Блок 2.6. Ошибки, исключения, стандартная библиотека (2 недели) 🔄 В ПРОЦЕССЕ (сеанс 12: 2026-07-09, начат внепланово до 2.4/2.5)

- [ ] `try/except/else/finally`, иерархия исключений, свои классы исключений — демо готово, практика начата (2026-07-09)
  - Файлы: `01_exceptions_basics_demo.py` ✅, `02_exceptions_basics_task.py` 🔄 (0/8 заданий)
